...
3. Buka Command Promp atau Git Bash, lalu ketik - git --version - untuk melihat versi git yang diinstal
<img width="310" height="66" alt="image" src="https://github.com/user-attachments/assets/460b0fd3-768d-486c-9155-3a18a9e15325" />
4. Selanjutnya, lakukan konfigurasi nama dan email dengan kode - git config --global user.name "Nama kamu" - dan - git config user.email "email@kamu.com"
